...
public class MatrixDriver
{
	public static void main(String[] args) throws IOException
	{
		...
		double[][] matrix1 = readMatrixFromFile(matrixFilename1);//calls readMatrixFromFile and passes matrixFilename1 and stores it in matrix1
        
        //-----------------------------matrix two----------------------------
		System.out.println("Enter name of file containing second matrix:");
		String matrixFilename2 = IO.readString();
		double[][] matrix2 = readMatrixFromFile(matrixFilename2);//calls readMatrixFromFile and passes matrixFilename2 and stores it in matrix2
